...
import sv.gob.mined.uaci.servlet.datasources.GarantiasVencidasDatasource;
 ...
 * @author INFORMATICA
 */
public class RptGarantiasXvencer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Date fechaV = (Date) (request.getSession().getAttribute("fechaV"));
            if(garantias != null && fechaV != null){
                ...
                parametros.put("fechaV", fechaV);
                //Se especifíca la ruta del reporte de ireport a compilar por JasperReport
                JasperReport reporte = null;
                //Se especifíca la ruta del reporte de ireport a compilar por JasperReport
                reporte = (JasperReport) JRLoader.loadObject(getServletContext().getRealPath("resources/reportes/rptGarantiasXvencer.jasper"));
                
                GarantiasVencidasDatasource datasource = new GarantiasVencidasDatasource();
                for(Garantia g : garantias){
                    GarantiaVencida gv = new GarantiaVencida();
