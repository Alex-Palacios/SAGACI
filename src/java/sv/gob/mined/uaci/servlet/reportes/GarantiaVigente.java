...
public class GarantiaVigente {
    ...
    public GarantiaVigente() {
    }

    public GarantiaVigente(String clave, String tipo, String fRecepcion, String proceso, String descripcion, String contrato, String proveedor, String afianzadora, String tecnico, String numGarantia, String fVenc, String plazo, BigDecimal monto) {
        this.clave = clave;
        this.tipo = tipo;
