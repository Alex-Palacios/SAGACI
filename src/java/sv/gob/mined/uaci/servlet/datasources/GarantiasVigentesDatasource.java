 ...
 * @author Alex
 */
public class GarantiasVigentesDatasource implements JRDataSource {

    private List<GarantiaVigente> lista = new ArrayList<GarantiaVigente>();
    private int index = -1;
    ...
    public List<GarantiaVigente> getLista() {
        return lista;
    }
    
    //AGREGA UN REGISTRO A LA LISTA
    public void addLista(GarantiaVigente cuenta){
